...
if(isset($_POST['simpan'])) {
          ...
          <div class="row">
            <div class="col-lg-12 ">
              <div class="alert alert-info">
                <strong><h2><b>Selamat datang</b></h2></strong><b style="font-size: 18px;"><?php echo $_SESSION['nama_mhs']; ?></b> Di Aplikasi E-Pemira
              </div>   
            </div>
          </div>
  ...
  <div class="footer">
    <div class="row">
      <div class="col-lg-12" >
        &copy; Copyright BEM BIU <?php echo date('Y') ?> <a href="http://binarytheme.com" style="color:#fff;" target="_blank"></a>
      </div>
    </div>
  </div>
